...
#It will not provide any information about spreading of data 
#xyCorr(0,0) -> present varience of data x
#xyCorr(1,1) -> present varience of data y
#varience also represents spreading of data. higher value means more spreading and vice versa

#xyCorr(0,1) and xyCorr(1,0) boths sign and values are important 
#The values will be in a range between -1 to +1
#higher number reflects higher correlation between columns
...
#spreadingInfo holds the values of varience of column x and y consecutively
